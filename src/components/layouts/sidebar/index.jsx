...
function Sidebar({ className, darkMode, toogleDarkMode }) {
  return (
    <div
      id="sidebar"
      className={`${className} fixed transition-all duration-300 flex flex-col py-6 bg-white dark:bg-[rgba(15,15,15,0.95)] shadow-sm  self-start top-0 bottom-0 h-full z-[500] md:text-2xl overflow-y-auto`}
    >
      <div className="flex flex-col items-left px-6 w-full">
        ...
        <ListOption text={"Clientes"} link={"/dashboard/guests"} active={true} />
        <ListOption
          text={"Tipos de Envio"}
